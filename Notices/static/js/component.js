    ...
    connectedCallback() {
        ...
        <div class='menu-bar'>
            <div class='menu'>
                ...
                <ul class='menu-links'>
                    <li class='nav-link'>
                    <button onclick="window.location.href='https://example.com'">Link Button</button>
                    ...
                    <li class='nav-link'>
                    <button onclick="window.location.href='drive.html'">Link Button</button>
...
class Activity extends HTMLElement {
    connectedCallback() {
        fetch('activities.html') // Load the content of activity.html
            .then(response => response.text()) // Parse the response as text
            .then(html => {
                this.innerHTML = html; // Set the HTML content to the fetched content
            })
            .catch(error => {
                console.error('Error fetching activity.html:', error);
            });
    }
}
